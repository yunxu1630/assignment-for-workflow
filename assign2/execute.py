...
url_request = requests.request('GET',url)
url_json = json.loads(url_request.text)

result = []

for i in range(len(url_json['features'])):
#Some loop
    buname = url_json['features'][i]['properties']['bu_name']
